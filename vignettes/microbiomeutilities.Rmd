...
```{r,fig.width=7, fig.height=4, eval=TRUE, message=FALSE}
library(microbiomeutilities)
library(RColorBrewer)
data("zackular2014")
ps0 <- zackular2014
...
p_v + scale_x_log10() + scale_y_log10() + theme_biome_utils()
#p <- p_v + ggrepel::geom_text_repel(data= subset(selctdf, meanPrev >=0.95) ,
#                                    aes(meanPrev,MeanAbun,label=Taxa), size=3)
