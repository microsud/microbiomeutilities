...
data("zackular2014")
p0 <- zackular2014
grp_abund <- get_group_abundances(p0, level = "Phylum", group="DiseaseState")
```

How to visusalize these data?  
```{r fig.height=4, fig.width=6, fig.align='center'}
mycols <- c("brown3", "steelblue","grey50")

grp_abund %>% # input data
  ggplot(aes(OTUID, mean_abundance)) + # x and y axis 
  geom_bar(aes(fill=DiseaseState), # fill by Group
           stat = "identity", 
           position="dodge") +
...
```{r fig.width=6, fig.height=6, eval=TRUE, message=FALSE, fig.align='center'}
library(microbiome)
library(microbiomeutilities)
data("zackular2014")
p0 <- zackular2014
...
By default this function internally calculated Prevalence, but purposely  doesn't plot by default. This is to give access to powerful `pheatmap` annotation options.  
