...
Area plots a good way of visualizing changes in abundances on individual participants, or bioreactors sampled over time.   
...
By default this function internally calculates _Prevalence_, but purposely doesn't plot it by default. This is to give access to powerful `pheatmap` annotation options.  
