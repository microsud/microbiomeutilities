...
#'           }
#' @keywords utilities
plot_taxa_composition <- function (x, taxonomic.level = "OTU", sample.sort = NULL, otu.sort = NULL, x.label = "sample", plot.type = "barplot", verbose = FALSE, transform = NULL, mar = c(5, 12, 1, 1), average_by = NULL, ...) {
